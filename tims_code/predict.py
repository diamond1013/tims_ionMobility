...
from pepim import PeptideIonMobilityPredictor
from pepim.models import max_sequence_length
...
predictor = PeptideIonMobilityPredictor()
...
for file in filenames:
    ...
    with open(re.sub(r'\.peptide\.csv$', '.prediction.ionMobility.csv', file), 'w') as f:
    # with open(re.sub(r'\.ionMobility\.csv$', '.prediction.ionMobility.csv', file), 'w') as f:
    # with open(re.sub(r'\.sequence\.txt$', '.prediction.ionMobility.csv', file), 'w') as f:
